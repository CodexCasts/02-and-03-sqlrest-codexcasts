...
//@interface sqlrestdemoObject : NSObject
//@end

@interface sqlrestdemoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[sqlrestdemoObject class]])
		{
			for (NSString *key in [[(sqlrestdemoObject*)o modules] allKeys])
			{
