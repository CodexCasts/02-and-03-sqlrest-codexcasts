...
@interface sqlrestdemoObject : KrollCoverageObject {
#else
@interface sqlrestdemoObject : KrollObject {
#endif
@private
...
extern NSString * sqlrestdemo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	sqlrestdemoObject *_sqlrestdemo;
    KrollObject* console;
	BOOL shutdown;
