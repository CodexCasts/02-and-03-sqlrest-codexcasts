...
/**
 The base class for all sqlrestdemo modules
 */
...
/**
 sqlrestdemo Platform calls this method on startup.
 */
-(void)startup;

/**
 sqlrestdemo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 sqlrestdemo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 sqlrestdemo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 sqlrestdemo Platform calls this method on resume.
 @param sender The sender of the event.
 */
