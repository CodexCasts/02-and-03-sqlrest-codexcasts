...
/**
 Base class for all sqlrestdemo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the sqlrestdemo view hierarchy (such as wrapped iOS UIViews) was touched.
